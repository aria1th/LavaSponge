package aria1th.main.lavasponge.gui;
...
public class LavaSpongeModScreen extends Screen {

    private OptionListWidget list;
    private final Configs configs;
    private final Screen parent;

    public LavaSpongeModScreen(Screen parent) {
        super(new LiteralText("LavaSpongeModMod Options"));
    ...
    public void init() {
        ...
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 155, this.height - 29, 150, 20, Text.of("Reset Config"), (buttonWidget) -> {
            ...
            this.client.setScreen(new LavaSpongeModScreen(this));
        }));
    }
